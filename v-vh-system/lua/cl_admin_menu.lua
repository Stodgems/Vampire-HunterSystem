...
net.Receive("OpenAdminMenu", function()
    ...
    local makeVampireButton = vgui.Create("DButton", frame)
    ...
    local makeHunterButton = vgui.Create("DButton", frame)
    ...
    local addBloodButton = vgui.Create("DButton", frame)
    ...
    local addExperienceButton = vgui.Create("DButton", frame)
    ...
    local removeRoleButton = vgui.Create("DButton", frame)
    ...
    local addHeartsButton = vgui.Create("DButton", frame)
    ...
    local addMedallionsButton = vgui.Create("DButton", frame)
    ...
    local manageMerchantItemsButton = vgui.Create("DButton", frame)
